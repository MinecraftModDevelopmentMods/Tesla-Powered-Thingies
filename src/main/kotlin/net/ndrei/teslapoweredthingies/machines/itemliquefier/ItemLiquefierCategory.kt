...
object ItemLiquefierCategory
    ...
    override fun register(registry: IRecipeCategoryRegistration) {
        ...
        this.recipeBackground = this.guiHelper.createDrawable(ThingiesTexture.JEI_TEXTURES.resource, 124, 66, 124, 66)
        fluidOverlay = this.guiHelper.createDrawable(ThingiesTexture.JEI_TEXTURES.resource, 160, 84, 8, 27)
    }
