...
object FluidSolidifierCategory
    ...
    override fun register(registry: IRecipeCategoryRegistration) {
        ...
        this.recipeBackground = this.guiHelper.createDrawable(ThingiesTexture.JEI_TEXTURES.resource, 0, 132, 124, 66)
        lavaOverlay = this.guiHelper.createDrawable(ThingiesTexture.JEI_TEXTURES.resource, 8, 147, 8, 27)
        waterOverlay = this.guiHelper.createDrawable(ThingiesTexture.JEI_TEXTURES.resource, 20, 147, 8, 27)
    }
