 ...
 */
@AutoRegisterItem
object MachineRangeAddonTier2
    : BaseTieredAddon(TeslaThingiesMod.MODID, TeslaThingiesMod.creativeTab, "addon_range_tier2") {
    ...
    override val recipe: IRecipe
        get() = ShapedOreRecipe(null, ItemStack(this, 1),
                ...
                'c', BaseAddonItem,
                'r', "dustRedstone",
                'g', GearRegistry.getMaterial(MATERIAL_DIAMOND)?.oreDictName ?: "gearDiamond"
        )
}